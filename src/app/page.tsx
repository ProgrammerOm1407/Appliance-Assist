...
export default function HomePage() {
  return (
    <div className="space-y-16">
      {/* Hero Section */}
      <section className="text-center py-16 bg-gradient-to-br from-accent/30 via-background to-background rounded-xl shadow-lg">
        <div className="container mx-auto px-4">
          <h1 className="text-5xl md:text-6xl font-headline font-bold mb-6 text-primary">
            Appliance Troubles? We Can Help!
          </h1>
          <p className="text-xl text-foreground/80 mb-10 max-w-2xl mx-auto font-body">
          ...
          <Button size="lg" asChild className="bg-primary text-primary-foreground hover:bg-primary/90 transition-transform duration-200 ease-in-out hover:scale-105 shadow-md">
      ...
      {/* Features Section */}
      <section>
        <h2 className="text-4xl font-headline font-semibold text-center mb-12">Our Services</h2>
          ...
          {features.map((feature) => (
            <Card key={feature.title} className="hover:shadow-xl transition-shadow duration-300 ease-in-out flex flex-col">
              ...
              <CardContent className="text-center flex-grow flex flex-col justify-between">
                <CardDescription className="mb-6 text-foreground/70 font-body">{feature.description}</CardDescription>
                <Button asChild variant="outline" className="mt-auto border-primary text-primary hover:bg-primary hover:text-primary-foreground transition-colors">
      ...
      <section className="py-16 bg-secondary/50 rounded-xl">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-headline font-semibold text-center mb-12">Why Choose Appliance Assist?</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {whyChooseUs.map((item) => (
              <div key={item.title} className="text-center p-6 bg-card rounded-lg shadow-md">
                <item.icon className="mx-auto h-12 w-12 text-accent mb-4" />
                <h3 className="text-2xl font-headline font-medium mb-2">{item.title}</h3>
      ...
      <section>
        <h2 className="text-4xl font-headline font-semibold text-center mb-12">Simple & Easy Process</h2>
        <div className="grid md:grid-cols-3 gap-8 items-start">
          <div className="text-center p-6">
            ...
            <h3 className="text-2xl font-headline font-medium mb-2">1. Describe Your Issue</h3>
            <p className="text-foreground/70 font-body">Tell us about the problem or use our AI tool for a quick diagnosis.</p>
          </div>
          <div className="text-center p-6">
             <div className="relative w-40 h-40 mx-auto mb-4">
            ...
            <h3 className="text-2xl font-headline font-medium mb-2">2. Book a Service</h3>
            <p className="text-foreground/70 font-body">Choose a convenient time for our technician to visit.</p>
          </div>
          <div className="text-center p-6">
             <div className="relative w-40 h-40 mx-auto mb-4">
            ...
            <h3 className="text-2xl font-headline font-medium mb-2">3. Get It Fixed</h3>
            <p className="text-foreground/70 font-body">Our expert technicians will resolve the issue efficiently.</p>
          </div>
        </div>
      </section>
    </div>
